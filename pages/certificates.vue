    ...
    <div class="text-center">
        ...
        <div class="text-left max-w-5xl mx-auto space-y-1 p-16 rounded-xl">
            ...
            <div v-if="showOption6">
                ...
                <h6>Benefits</h6>
                <p>"The Improvement Standard" with ISO 9001:2000 as the basic quality management system, organizations achieving certification to AS9100 receive dual benefits. First, they benefit from the process approach, with emphasis on continuous improvement and communication. This means that the organization knows, understands, and practices a philosophy that is committed to quality in all actions, never settles for “good enough” and understands the dynamics and interactions that exist between the various processes that make up the quality management system.  Secondly, the added requirements of AS9100, although prescriptive in nature, are based on proven techniques that further enhance an organization's ability to achieve high quality levels in the challenging automotive sector.</p>
                ...
                <p>Single quality system registration to meet multiple customer quality requirements</p>
                <p>Incorporates the best lessons learned from the global automotive segment</p>
                <p>Improved staff morale through increased management efficiencies</p>
                <p>Continuous improvement of business performance through ongoing certification audits</p>
                <p>Bottom-line benefits through increased efficiency, reduced waste and better utilization of resources</p>

                <a
                href="~/assets/images/pdfs/ACF088_B_Supplier_Agreement_1 (1).pdf"  download class="py-3 px-5 mt-4 mr-1 mb-1 w-max rounded-lg text-neutrals-100 relative inline-flex group items-center justify-center cursor-pointer border-b-4 border-l-2 active:border-darkGreen-700 active:shadow-none shadow-xl bg-gradient-to-tr from-darkGreen-700 to-darkGreen-700 border-darkGreen-700">
                    <span class="absolute w-0 h-0 transition-all duration-300 ease-out bg-white rounded-full group-hover:w-32 group-hover:h-32 opacity-10"></span>
                    <span class="relative font-manrope">View Certificate</span>
                </a>
            </div>
            ...
            <div v-if="showOption7">
                ...
                <p>It was prepared by the International Automotive Task Force (IATF) and the "Technical Committee" of ISO. It harmonizes the country-specific regulations of Quality-Management-Systems.</p>
                <p>About 30 percent of the more than 100 existing automobile manufacturers affiliate the requirements of the norm but especially the large Asian manufacturers have differentiated, own requirements for the quality management systems of their corporate group and their suppliers.</p>

                <h6 class="font-bold font-ubuntu">Benefits</h6>
                <p>"The Improvement Standard"</p>

                <p>With ISO 9001:2000 as the basic quality management system, organizations achieving certification to ISO/TS 16949 receive dual benefits. First, they benefit from the process approach, with emphasis on continuous improvement and communication. This means that the organization knows, understands, and practices a philosophy that is committed to quality in all actions, never settles for “good enough” and understands the dynamics and interactions that exist between the various processes that make up the quality management system. Secondly, the added requirements of ISO/TS 16949, although prescriptive in nature, are based on proven techniques that further enhance an organization’s ability to achieve high quality levels in the challenging automotive sector.</p>
            ...
            <div v-if="showOption9">
                ...
                <p>Come into Alpha anytime if you’d like to inspect your boards during production. If a company is not willing to make this offer, regardless of being ITAR registered, then they may potentially be producing your product elsewhere.</p>

                <p>No matter the administration, International Traffic in Arms Regulation rules will not fundamentally change. A common misconception is that ITAR is only a response to terrorism. Additionally, ITAR is looking ahead and that is why it is imperative that we keep sensitive military and space technology away from potential enemies.</p>
            ...
            <div v-if="showOption10" class="space-y-2">
                ...
                <table>
                    ...
                    <tbody class="text-black">
                        <!-- Table rows -->
                        <tr class="bg-neutrals-100">
                            <td>1A-0</td>
                            <td>Iteq</td>
                            <td>IT-140TC</td>
                            <td>0.004"</td>
                            <td>0.00068" (0.5 Oz)</td>
                        </tr>
                        <tr  class="bg-neutrals-200">
                            <td></td>
                            <td></td>
                            <td>IT-588TC</td>
                            <td></td>
                        ...
                        <tr class="bg-neutrals-100">
                            ...
                            <td>S1000, S1000-2</td>
                            <td>0.002"</td>
                            <td>0.00033" (1/4 Oz)</td>
                        </tr>
                        <tr class="bg-neutrals-200">
                            <td></td>
                            <td></td>
                            <td>S1000-3, S1000-4</td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr class="bg-neutrals-100">
                        ...
                        <tr class="bg-neutrals-100">
                            <td></td>
                            <td></td>
                            <td>FR406, FR406N, FR406BC, FR406HR</td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr class="bg-neutrals-200">
            ...
            <div v-if="showOption11">
                ...
                <p class="font-manrope">Certified with Chicago Minority Supplier Development Council (CMSDC) as defined by the National Minority Supplier Development Council, Inc. (NMSDC) and as adopted by the Chicago Minority Supplier Development Council.</p>

                <p><span class="font-bold font-ubuntu">NAICS Code</span>334412</p>
                <p><span class="font-bold font-ubuntu">Product/Service Description:</span>Manufacturer of printed circuit boards</p>
