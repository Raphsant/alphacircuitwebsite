<template>
  <div>
    ...
    <section class="bg-lightGreen-50 flex mx-auto">
      <!-- Action Cards -->
      <div class="ml-20 m-16 flex-col flex space-y-5">
        <NuxtLink to="/quote">
          <div class="bg-darkGreen-900 text-neutrals-100 flex justify-center w-[24rem] py-8 pl-4 rounded-lg cursor-pointer hover:shadow-xl group">
