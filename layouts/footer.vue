    ...
    <div class="text-neutrals-100 bg-darkGreen-900 h-max absolute top-36 left-96 rounded-md">
      <div class="flex p-2 space-x-10">
        <div class="p-4 pr-8 flex-col space-y-1">
          <h5 class="">Address:</h5>
          <h6>730 N Oaklawn Ave,<br>Elmhurst, IL, 60126</h6>
        </div>
        ...
        <div class="p-4 pr-8">
          ...
          <h6>(630)-615-5555</h6>
          <h5 class="">Email:</h5>
          <h6>sales@alphacircuit.com</h6>
        </div>
  
        <div class="border-solid border-neutrals-100 border-l-2 left-2/4 h-75 mt-4"></div>
        <div class="flex space-x-2">
          <img class="self-center" src="../assets/images/logos/MBE-Logo-Alt-Color-60x60.png" alt="Minority Business Enterprise Logo">
          <img class="self-center" src="../assets/images/logos/UL.png" alt="UL Certified Logo">
          <img class="self-center" src="../assets/images/logos/download.png" alt="International Traffic In Arms Regulations Registered Certification Logo">
          <img class="self-center" src="../assets/images/logos/AS9100+Black+TM+png.png" alt="AS9100 Certification & ISO 9001 Certification Logo">
        </div>
      </div>
    </div>
  </footer>
